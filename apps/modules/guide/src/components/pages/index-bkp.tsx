...
import { selectState1, selectState2, selectState3, setState1, setState2, setName, setType, setAge } from 'Guide/store/reducers/person-reducer'
import { Button } from '@ms7/bui'
import TestProps from 'Guide/components/test-props'
