...
export type FetchOtherQuery = { __typename?: 'Query', cars: Array<{ __typename?: 'Car', id: string, similar: Array<{ __typename?: 'Car', id: string }> } | null> };
...
export const FetchOtherDocument = `
    query fetchOther {
  cars {
    id
    similar {
    ...
    `
export const useFetchOtherQuery = <
    TData = FetchOtherQuery,
    TError = unknown
>(
    dataSource: { endpoint: string, fetchParams?: RequestInit },
    variables?: FetchOtherQueryVariables,
    options?: UseQueryOptions<FetchOtherQuery, TError, TData>,
) =>
    useQuery<FetchOtherQuery, TError, TData>(
        variables === undefined ? ['fetchOther'] : ['fetchOther', variables],
        fetcher<FetchOtherQuery, FetchOtherQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, FetchOtherDocument, variables),
        options,
    )