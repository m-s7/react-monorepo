...
@REM To isolate internal variables from possible postThunk scripts, we use another setlocal
@setlocal
...
@REM check for postThunk script, once with legacy .bat ending and once with .cmd ending
